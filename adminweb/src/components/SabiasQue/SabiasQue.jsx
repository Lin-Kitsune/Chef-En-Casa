...
const IMAGE_BASE_URL = 'http://localhost:4000'; // Asegúrate que esta ruta esté bien configurada en tu servidor
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 flex flex-col h-full">
      <div className="flex-grow">
        ...
        <p className="text-sm text-gray-500 mt-2">{data.beneficio}</p>
      </div>
